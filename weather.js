...
//What is going on is that jQuery() is being defined as jQuery.fn.init() 
//which is another way to say jQuery.prototype.init() which is the selector function!
...
//index equals ==> eq
const formJquery = jQuery(".top-banner form").eq(0);
